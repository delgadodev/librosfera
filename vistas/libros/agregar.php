...
<div class="mb-4">
                ...
                <input type="text" id="titulo" name="titulo"  value="<?= $titulo ?>" class="w-full p-2 border rounded" required>
            </div>

            <div class="mb-4">
                <label for="descripcion" class="block text-gray-600 text-sm font-medium mb-2">Descripcion</label>
                <input type="text" id="descripcion" name="descripcion"  value="<?= $descripcion ?>" class="w-full p-2 border rounded" required>
                </input>
            </div>

            <div class="mb-4">
                <label for="autor" class="block text-gray-600 text-sm font-medium mb-2">Autor</label>
                <input type="autor" id="autor" name="autor"  value="<?= $autor ?>" class="w-full p-2 border rounded" required>
            </div>

            <div class="mb-4">
                <label for="genero" class="block text-gray-600 text-sm font-medium mb-2">Genero</label>
                <input type="tel" id="genero" name="genero"  value="<?= $genero ?>" class="w-full p-2 border rounded" required>
            </div>

            <div class="mb-4">
                <label for="fecha" class="block text-gray-600 text-sm font-medium mb-2">Fecha de publicacion</label>
                <input type="date" id="fecha" name="fecha"  value="<?= $fecha ?>" class="w-full p-2 border rounded" required>
            </div>

            <div class="mb-4">
                <label for="imagen" class="block text-gray-600 text-sm font-medium mb-2">Portada</label>

                <input type="file" id="imagen" name="imagen" acept="image/*"  value="<?= $imagen ?>" class="w-full p-2 border rounded" required>
            </div>
            ...
            <input type="file" id="archivo_pdf" name="archivo_pdf"  value="<?= $pdf ?>" accept=".pdf"  class="w-full p-2 border rounded" required>
            </div>
